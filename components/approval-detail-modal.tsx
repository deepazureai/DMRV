...
export function ApprovalDetailModal({
  ...
  const mockRecords = [
    {
      ...
      emission_factor_kg_co2_per_kwh: 0,
      co2_emissions_kg: 0,
    ...
    },
    {
      ...
      emission_factor_kg_co2_per_kwh: 0.02,
      co2_emissions_kg: 500,
      carbon_credits_generated: 400,
      fuel_type: 'Renewable',
    ...
    },
    {
      ...
      measurement_date: '2024-01-15',
      energy_source: 'Coal',
      energy_consumed_kwh: 85000,
      emission_factor_kg_co2_per_kwh: 1.47,
      co2_emissions_kg: 125000,
      carbon_credits_generated: 100000,
      fuel_type: 'Coal',
  ...
  const totalEmissions = mockRecords.reduce((sum, r) => sum + r.co2_emissions_kg, 0)
  const totalCredits = mockRecords.reduce((sum, r) => sum + r.carbon_credits_generated, 0)
